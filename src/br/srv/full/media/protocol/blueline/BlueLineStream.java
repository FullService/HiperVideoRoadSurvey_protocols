...
package br.srv.full.media.protocol.blueline;
...
public class BlueLineStream implements PushBufferStream, Runnable {
	...
	public BlueLineStream() {
		...
		rgbFormat = new RGBFormat(size, maxDataLength, Format.byteArray,
				frameRate, 24, 3, 2, 1, 3, size.width * 3, VideoFormat.FALSE,
	...
	public void read(Buffer buffer) throws IOException {
		synchronized (this) {
			...
			System.arraycopy(data, chunkStart, outdata, 0, maxDataLength
					- (chunkStart));
			if (chunkStart != 0) {
				System.arraycopy(data, 0, outdata, maxDataLength - chunkStart,
						chunkStart);
			}
